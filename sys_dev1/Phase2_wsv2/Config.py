...
class ColorPickerMode(Enum):
    """顏色選擇器模式"""
    DISABLED      = "disabled"
    PALETTE_12    = "palette_12"    # 🆕 12 色調色盤
    PALETTE_24    = "palette_24"
    PALETTE_48    = "palette_48"    # 🆕 48 色調色盤
...
class ToolbarConfig:
    ...
    color_palette: List[str] = field(default_factory=lambda: [
        ...
        "#008080", "#C0C0C0", "#FFC0CB", "#FFD700",
        "#4B0082", "#EE82EE", "#F5DEB3", "#D2691E",
        # 48 色（第 25-48 個）
        "#FF6347", "#FF7F50", "#FFD700", "#ADFF2F",
        "#7FFF00", "#00FA9A", "#00CED1", "#1E90FF",
        "#6495ED", "#9370DB", "#DB7093", "#FF69B4",
        "#CD853F", "#DEB887", "#F0E68C", "#E6E6FA",
        "#B0E0E6", "#ADD8E6", "#87CEEB", "#87CEFA",
        "#778899", "#708090", "#2F4F4F", "#696969",
    ])
